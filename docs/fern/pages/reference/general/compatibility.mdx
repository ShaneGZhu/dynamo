...
Current stable release: v1.4.1 (container tag `1.4.1`, wheel version `1.4.1`).
...
**Feature support by backend (v1.4.1)**
...
| LoRA | Experimental (Dynamic load/unload and aggregated serving validated; disaggregated serving not end-to-end validated) | Not supported | Supported (Dynamic load/unload; KV-aware routing supports adapter affinity) |
